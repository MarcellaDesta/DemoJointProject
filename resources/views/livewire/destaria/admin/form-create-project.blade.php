<div>
    <div x-data="{
        ...
        closeForm() {
            if(this.name !='' || this.description !='' || this.status !='' || this.category !=''){
        ...
        <div x-show="expanded">
            <div id="crud-modal"
                tabindex="-1" class="flex fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-md max-h-full">
                        <!-- Modal body -->
                        <form
                            wire:submit.prevent="sendDataProject"
                            class="p-4 md:p-5">
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    ...
                                    <select  wire:model="status" id="status" class="bg-gray-50 border border-gray-300 text-gray-900 textxt-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        <option selected="">Select Status</option>
                                        @foreach (\App\Helpers\Status:: status as $key => $value)
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    ...
                                    <select id="category" wire:model ="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        ...
                                        @foreach (\App\Helpers\Category:: categories as $key => $value)
                                              <option value="{{ $value }}"> {{ $key }} </option>
                                        @endforeach
                                        {{-- <option value="TV">TV/Monitors</option>
                                        <option value="PC">PC</option>
